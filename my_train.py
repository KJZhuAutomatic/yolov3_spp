        ...
        if opt.notest is False or epoch == epochs - 1:
            ...
            if opt.savebest is False:
                ...
                with open(results_file, 'r') as f:
                    ...
                    weight_file = wdir + 'yolov3spp-{}.pt'.format(epoch)
                    torch.save(save_files, weight_file)
            else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hyp', type=str, default='cfg/train_hyp.yaml', help='hyperparameters path')
